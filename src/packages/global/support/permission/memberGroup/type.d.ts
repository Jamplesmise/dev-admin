/**
 * 群组类型定义
 * 同步自官方 FastGPT: packages/global/support/permission/memberGroup/type.d.ts
 */
...
export type MemberGroupListItemType<WithMembers extends boolean | undefined = undefined> = MemberGroupSchemaType & {
