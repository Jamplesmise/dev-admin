...
export const valToStr = (val: string | number | boolean | object | null | undefined): string => {
...
export function replaceVariable(
  ...
  const hasCircularReference = (value: string | number | undefined, targetKey: string): boolean => {
